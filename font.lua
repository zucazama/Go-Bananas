    ...
    ['mullerNarrow'] = { 
        ['light'] = {
            ['size'] = {
                ...
                ['20'] = love.graphics.newFont('assets/fonts/muller_narrow/MullerNarrow-Light.otf', 20),
        ...
        ['lightItalic'] = {
            ['size'] = {
                ['20'] = love.graphics.newFont('assets/fonts/muller_narrow/MullerNarrow-LightItalic.otf', 20),
        ...
        ['extraBold'] = {
            ['size'] = {
                ['15'] = love.graphics.newFont('assets/fonts/muller_narrow/MullerNarrow-ExtraBold.otf', 15),
                ['20'] = love.graphics.newFont('assets/fonts/muller_narrow/MullerNarrow-ExtraBold.otf', 20),
                ...
                ['70'] = love.graphics.newFont('assets/fonts/muller_narrow/MullerNarrow-ExtraBold.otf', 70)
            }
        },
    },
